...
namespace CustomUserIdentityManagement.Areas.Identity.Pages.Account.Manage
{
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (user.UsernameChangeLimit > 0)
            {
                if (Input.Username != user.UserName)
                {
                    ...
                    {
                        StatusMessage = "Unexpcted error when trying to set user name.";
                        return RedirectToPage();
                    }
                    else
                    {
